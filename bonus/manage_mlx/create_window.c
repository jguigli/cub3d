...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/05 18:59:00 by jguigli           #+#    #+#             */
/*   Updated: 2022/09/05 18:59:02 by jguigli          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_window(t_main *main)
{
	...
	main->img->mlx_img = mlx_new_image(main->game->mlx_ptr,
			main->scr_x, main->scr_y);
	main->img->addr = (int *)mlx_get_data_addr(main->img->mlx_img,
